...
## Project Structure
    ...
    ├── testapiautocatalog_112817  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112817`
...
2. Clone this repo and `cd testapiautocatalog_112817`
